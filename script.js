...
const RABBIT_LINES = {
  idleShop: [
    "需要補充一點小蘋果能量嗎？今天的冒險看起來很精彩呢！",
    "星星每一顆都很珍貴，先想想現在最需要什麼補給吧～",
    "如果有重要的戰鬥要打，記得多帶幾顆蘋果在身上。"
  ],
  idleEquip: [
    "想變得更帥氣、更強壯嗎？就交給兔兔工匠吧！",
    "裝備升級後，壞情緒就更難打倒你囉～✨",
    "有時候不是你不夠努力，只是裝備還可以再強化一點點。"
  ],
  buyItem: [
    "已經幫你包裝好囉，記得在關鍵時刻好好善用它～",
    "補給完成！冒險途中也別忘了照顧自己的心情。",
    "謝謝惠顧～希望這個道具能讓你更安心地往前走！"
  ],
  notEnoughStars: [
    "嗯…星星好像不太夠，再多安撫幾隻魔物就可以買到了！",
    "星星目前還不夠，我相信你很快就能存到想要的數量～",
    "先別急著購買，或許可以再去地圖上多收集一些勇氣星星。"
  ],
  equipBuy: [
    "新裝備到手！已經幫你調整到最適合你的尺寸囉～",
    "這把武器跟你很合，感覺會一起創造很多回憶呢！",
    "穿上去的那一刻，你就跟剛剛長得有點不一樣了，變得更帥氣了！"
  ],
  equipUpgrade: [
    "升級完成！金屬的光澤都變得不一樣了～✨",
    "嘎啦嘎啦…好了！這次的強化非常順利，威力大幅提升！",
    "每一次升級，都是對自己努力的一種獎勵～"
  ],
  equipSwitch: [
    "已幫你換上這套裝備，記得活動一下身體試試手感～",
    "造型換新！有時候換套衣服，心情也會跟著變好呢～",
    "已切換成新的搭配，如果不習慣，隨時可以再調整～"
  ]
};
...
function setShopNpcLine(text) {
  const el = document.querySelector(".shop-npc-line");
  if (!el) return;
  el.textContent = "兔兔工匠：" + text;
}
/* ==========================================================
